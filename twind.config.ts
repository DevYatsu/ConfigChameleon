...
export default {
  ...defineConfig({
    ...
    rules: [
      ...
      ["hljs-punctuation", "text-white bg-inherit"],
      ["hljs-number", "text-violet-500 bg-inherit"],
      ["hljs-attr", "text-rose-500 bg-inherit"],
      ["hljs-string", "text-lime-400 bg-inherit"],
      ["hljs-keyword", "text-violet-500 bg-inherit"],
    ],
  }),
